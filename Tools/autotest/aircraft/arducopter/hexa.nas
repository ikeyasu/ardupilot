...
var update_quad = func( ) {
    ...
    setprop("/apm/motor_front2",  round10(getprop("/engines/engine[0]/fuel-flow-gph")/10.0));
    setprop("/apm/motor_back2",   round10(getprop("/engines/engine[1]/fuel-flow-gph")/10.0));
}
